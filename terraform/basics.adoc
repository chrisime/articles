...
<2> Eine aussagekräftige Beschreibung ist nie verkehrt und es ist Best-Practise.
...
<5> Default Value ist nicht unbedingt erforderlich. Allerdings wird der Entwickler beim Ausführen des Scripts jedes Mal aufgefordert für _doh_ einen Wert anzugeben. Möchte man keinen default value hier setzen, muss eine Datei angelegt werden.
